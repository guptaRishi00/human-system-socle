...
export const metadata = {
    ...
    description: "Read our latest insights on HR tech, company culture, and performance management.",
};
    ...
    return (
        <main className="min-h-screen bg-[#FAFAFA] text-[#1A1A1A] selection:bg-emerald-100">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="max-w-3xl">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Thought leadership and practical guides for modern HR professionals and cultural architects.
                        </p>
                    </div>
                </div>
            </header>
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-10 py-16">
                ...
                {featuredBlog && (
                    <div className="mb-24">
                        <div className="group relative grid grid-cols-1 lg:grid-cols-12 gap-0 bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500">
                            <div className="lg:col-span-7 overflow-hidden">
                                <div className="aspect-[16/10] lg:h-full bg-gray-100">
                                    <BlogCard blog={featuredBlog} />
                                </div>
                            </div>
                            <div className="lg:col-span-5 p-8 md:p-12 flex flex-col justify-center bg-white">
                                <span className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-4">Featured Article</span>
                                ...
                                <p className="text-gray-600 mb-8 line-clamp-3">
                                    {featuredBlog.excerpt || "Explore our deep dive into how modern organizations are evolving their human systems for the digital age."}
                                </p>
                                <Link
                                    href={`/blog/${featuredBlog.slug}`}
                                    className="inline-flex items-center gap-2 font-bold text-sm uppercase tracking-wider group/link"
                                >
                                    Read Article <ChevronRight size={18} className="group-hover/link:translate-x-1 transition-transform" />
                                </Link>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex items-end justify-between mb-10 border-b border-gray-200 pb-6">
                    ...
                    <span className="text-sm text-gray-500 font-medium">{remainingBlogs.length} Articles</span>
                </div>
