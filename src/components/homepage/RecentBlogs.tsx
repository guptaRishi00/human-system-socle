...
export default function RecentBlogs() {
    ...
    return (
        <section className="relative w-full py-24 px-6 md:px-20 bg-[#04231d] overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-emerald-800/30 to-transparent" />
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div className="max-w-xl">
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold text-white leading-tight">
                            Read Our <br /> <span className="text-[#E3FFCD]">Latest Blogs</span>
                        </h2>
                    </div>

                    <Link href="/blog">
                        <button className="flex items-center gap-3 px-8 py-4 bg-[#E3FFCD] text-[#013228] rounded-full font-bold text-xs tracking-widest hover:scale-105 transition-transform shadow-lg shrink-0">
