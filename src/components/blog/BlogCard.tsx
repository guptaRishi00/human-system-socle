...
export default function BlogCard({ blog }: { blog: BlogPost }) {
    return (
        <article className="group relative bg-[#0a2e26]/80 backdrop-blur-sm rounded-[32px] p-6 border border-emerald-800/30 flex flex-col transition-all duration-300 hover:scale-[1.02] hover:border-emerald-500/30 overflow-hidden h-full">
            {/* Category Badge */}
